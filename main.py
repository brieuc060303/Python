...
def main():
    ...
    sharks_df, sharks_activity, sharks_year, sharks_species = filtration_df()
    ...
    create_dashboard(app, fig_year, fig_sx, fig_activity, fig_world, fig_hours, fig_time_periods, fig_age)        #create the dashboard
